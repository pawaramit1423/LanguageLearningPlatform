package com.llp.fluentflow.application.model;
...
@Entity
@ApiModel(description="All details about the Enrollment. ")
public class Enrollment 
{
	...
	public Enrollment(int id, String coursename, String courseid, String enrolleddate, String enrolledusername, String enrolleduserid, String enrolledusertype , String enrolledcount, String youtubeurl, String websiteurl, String coursetype, String skilllevel, String language, String description)
	{
		super();
		this.id = id;
