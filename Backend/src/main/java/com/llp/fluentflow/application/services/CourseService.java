package com.llp.fluentflow.application.services;
...
import com.llp.fluentflow.application.repository.CourseRepository;
...
public class CourseService 
{
	...
	{
		return (List<Course>)courseRepo.findAllByLanguage(language);
	}
